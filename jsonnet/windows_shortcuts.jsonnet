...

{
  ...
  rules: [
    ...
    // xmrflipflop - custom
    k.rule('Hyphen (Ctrl) [Browsers]',
           k.input('hyphen', ['control']),
           k.outputKey('hyphen', ['left_command']),
           k.condition('if', bundle.webBrowsers)),
    k.rule('Keypad Minus (Ctrl) [Browsers]',
           k.input('keypad_hyphen', ['control']),
           k.outputKey('keypad_hyphen', ['left_command']),
           k.condition('if', bundle.webBrowsers)),
    k.rule('Equal (Ctrl) [Browsers]',
           k.input('equal_sign', ['control']),
           k.outputKey('equal_sign', ['left_command']),
           k.condition('if', bundle.webBrowsers)),
    k.rule('Keypad Plus (Ctrl) [Browsers]',
           k.input('keypad_plus', ['control']),
           k.outputKey('keypad_plus', ['left_command']),
           k.condition('if', bundle.webBrowsers)),
    k.rule('0 (Ctrl) [Browsers]',
           k.input('0', ['control']),
           k.outputKey('0', ['left_command']),
           k.condition('if', bundle.webBrowsers)),
    k.rule('1 (Ctrl) [Browsers]',
           k.input('1', ['control']),
           k.outputKey('1', ['left_command']),
           k.condition('if', bundle.webBrowsers)),
    k.rule('2 (Ctrl) [Browsers]',
           k.input('2', ['control']),
           k.outputKey('2', ['left_command']),
           k.condition('if', bundle.webBrowsers)),
    k.rule('3 (Ctrl) [Browsers]',
           k.input('3', ['control']),
           k.outputKey('3', ['left_command']),
           k.condition('if', bundle.webBrowsers)),
    k.rule('4 (Ctrl) [Browsers]',
           k.input('4', ['control']),
           k.outputKey('4', ['left_command']),
           k.condition('if', bundle.webBrowsers)),
    k.rule('5 (Ctrl) [Browsers]',
           k.input('5', ['control']),
           k.outputKey('5', ['left_command']),
           k.condition('if', bundle.webBrowsers)),
    k.rule('6 (Ctrl) [Browsers]',
           k.input('6', ['control']),
           k.outputKey('6', ['left_command']),
           k.condition('if', bundle.webBrowsers)),
    k.rule('7 (Ctrl) [Browsers]',
           k.input('7', ['control']),
           k.outputKey('7', ['left_command']),
           k.condition('if', bundle.webBrowsers)),
    k.rule('8 (Ctrl) [Browsers]',
           k.input('8', ['control']),
           k.outputKey('8', ['left_command']),
           k.condition('if', bundle.webBrowsers)),
    k.rule('9 (Ctrl) [Browsers]',
           k.input('9', ['control']),
           k.outputKey('9', ['left_command']),
           k.condition('if', bundle.webBrowsers)),
    ...
    k.rule('L (Cmd)',
           k.input('l', ['command']),
           k.outputKey('q', ['left_control', 'left_command']),
           k.condition('unless', bundle.hypervisors + bundle.remoteDesktops, file_paths.remoteDesktops)),
    k.rule('Esc (Ctrl+Shift)',
           k.input('escape', ['left_control', 'left_shift']),
           k.outputShell("open -a 'Activity Monitor.app'"),
           k.condition('unless', bundle.hypervisors + bundle.remoteDesktops, file_paths.remoteDesktops)),
    k.rule('Esc (Ctrl)',
           k.input('escape', ['left_control']),
